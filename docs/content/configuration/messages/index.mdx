...
- Takes: a string
- Current template default: `"<green>Identica</green> <dark_gray>| "`
...
- Current template default: `"dd.MM.yyyy"`
...
- Takes: a date-time pattern string
- Current template default: `"dd.MM.yyyy HH:mm:ss"`
...
- Takes: a string
- Current template default: `"<red><click:run_command:/identica help {previousPage}>«</red> "`
...
- Takes: a string
- Current template default: `" <green><click:run_command:/identica help {nextPage}>»</green>"`
