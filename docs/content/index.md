...
Most authentication plugins treat ideas like cracked auth, premium auth, or website auth as built-in product features.
...
That means cracked authentication is just a provider.
...
- You are not locked into one opinionated "premium vs cracked" architecture.
...
| Cracked authentication                                       | Yes, via provider                                               | Yes                                      | Yes                                  | Yes                                      | Yes                                  | Yes                                  | Yes                                          |
...
| Can premium/cracked logic be removed entirely                | Yes                                                             | No                                       | No                                   | No                                       | No                                   | No                                   | No                                           |
...
Identica is not trying to be "another cracked and premium plugin."
It is trying to be the provider-oriented foundation that cracked, premium, website, and future authentication
