...
public final class AuthoritativeUsernameSchemaContributor implements SchemaContributor {
	...
	public void contribute(@NotNull SchemaManager schemaManager) {
		...
		schemaManager
				.scanPackages(classLoader, "me.whereareiam.identica.provider.capability.authoritative.username.database.entity")
				.registerMigrationScope("authoritative-username", scope -> scope
						.scanPackages(classLoader, "me.whereareiam.identica.provider.capability.authoritative.username.database.migration"));
	}
}
