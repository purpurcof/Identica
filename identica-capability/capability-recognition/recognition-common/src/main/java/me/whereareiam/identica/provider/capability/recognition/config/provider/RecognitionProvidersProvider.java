	...
	protected Configura configura() {
		return Config.configured().withFeature(ExtensionFeature.rule(
				ConfigDocumentRule.when(
						...
						RecognitionCapabilities.class,
						RecognitionProvidersProvider::isRecognitionCapabilitiesNode
				)
		));
	}

	private static boolean isRecognitionCapabilitiesNode(@NotNull DocumentTypeContext context) {
