...
public class ProviderStepStage implements StepStage {
	...
	public @NotNull List<AuthenticationStep> steps(
		...
		List<StepDefinition> definitions = stepRegistry.resolve(providerId, StepPhase.PROVIDER, flow);
	...
	public boolean allowFallback(
		...
		return flow == AuthFlowType.SEAMLESS;
	}
