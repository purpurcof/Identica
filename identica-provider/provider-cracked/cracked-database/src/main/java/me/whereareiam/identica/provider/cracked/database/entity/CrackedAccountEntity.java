...
@Entity(tableName = "identica_cracked_accounts")
public class CrackedAccountEntity implements EntitySchemaProvider {
	...
	public String statement(String databaseType) {
		...
		return """
				CREATE TABLE IF NOT EXISTS identica_cracked_accounts (
