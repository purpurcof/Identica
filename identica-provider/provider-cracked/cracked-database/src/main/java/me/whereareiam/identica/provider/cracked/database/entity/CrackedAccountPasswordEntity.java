package me.whereareiam.identica.provider.cracked.database.entity;
...
@Entity(tableName = "identica_cracked_account_passwords")
public class CrackedAccountPasswordEntity implements EntitySchemaProvider {
	...
	public String statement(String databaseType) {
		...
		return """
				CREATE TABLE IF NOT EXISTS identica_cracked_account_passwords (
