...
@Singleton
public class CredentialSessionReuseStep extends AbstractCredentialStep {
	private final SessionService sessionService;

	@Inject
	public CredentialSessionReuseStep(SessionService sessionService) {
	...
	public @NotNull CompletableFuture<StepResult> execute(@NotNull ScenarioContext context) {
		...
		Optional<Session> existingSession = sessionService
				.findByProviderSubject(CredentialConstants.PROVIDER_ID, providerSubject)
				.join();
