...
@RegisterBeanMapper(CredentialAccountEntity.class)
public interface CredentialAccountRepository {
	@SqlQuery("""
			SELECT provider_id AS providerId,
			  ...
			  FROM identica_provider_credential_accounts
			 WHERE provider_id = :providerId
			   AND provider_subject = :providerSubject
			""")
	Optional<CredentialAccountEntity> findBySubject(
	...
	@SqlUpdate("""
			UPDATE identica_provider_credential_accounts
